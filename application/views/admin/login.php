...
<body class="b hold-transition login-page bg-login align-center text-center">
  <div class="login-box text-center">
    <div class="center">
      <!-- <img class="img-responsive text-center" src="http://sikamus.bii-design.com/assets/dist/img/cpp.png" alt="User profile picture"> -->
    </div>
    <!-- /.login-logo -->
...
<?php echo $this->session->flashdata('msg'); ?>
      ...
      <form action="<?=site_url('C_admin/cek_login')?>" method="post">
        ...
        <div class="row">
          ...
          <div class="col-xs-5 pull-left">
            <a href="<?=site_url('C_admin/register')?>" type="button" class="btn btn-warning btn-block btn-flat">Register</a>
          </div>
